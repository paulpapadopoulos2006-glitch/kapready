export const PROPERTY = {
  ...
  description:
    'A bright, modern 48 m² apartment designed for independence, comfort and style. ' +
  ...
  seo: {
    ...
    description: 'Book KAP Home directly in Chios, Greece. Bright 48 m² apartment for up to 3 guests in the city centre — beach under 1 km, free parking, 200 Mbps WiFi. No Airbnb fees. Best price guaranteed at €90/night.',
    keywords: [
